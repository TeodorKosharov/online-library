...
from online_library_server.core.views import get_books, get_user_books, add_book, edit_book, delete_book, \
    details_book, get_comments, add_comment, delete_comment

urlpatterns = (
    path('get-books/', get_books),
    path('get-user-books/<int:user_id>/', get_user_books),
